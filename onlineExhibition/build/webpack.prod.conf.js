...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: '../dist/artist.html',
      template: './src/view/artist/artist.html',
      inject: true,
      chunks:['artist','vendor','manifest'],
      minify: {
        removeComments: true,
    ...
    new HtmlWebpackPlugin({
      filename: '../dist/exhibition.html',
      template: './src/view/exhibition/exhibition.html',
      inject: true,
      chunks:['exhibition','vendor','manifest'],
      minify: {
        removeComments: true,
        collapseWhitespace: true,
        removeAttributeQuotes: true
    ...
    new HtmlWebpackPlugin({
      filename: '../dist/information.html',
      template: './src/view/personal_information/information.html',
      inject: true,
      chunks:['information','vendor','manifest'],
      minify: {
        removeComments: true,
        collapseWhitespace: true,
        removeAttributeQuotes: true
    ...
    new HtmlWebpackPlugin({
      filename: '../dist/artists.html',
      template: './src/view/artists/artists.html',
      inject: true,
      chunks:['artists','vendor','manifest'],
      minify: {
        removeComments: true,
        collapseWhitespace: true,
        removeAttributeQuotes: true
