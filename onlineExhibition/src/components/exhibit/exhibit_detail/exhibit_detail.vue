      ...
      this.$http.get('http://qb4dwjh.hk1.mofasuidao.cn/get_signature/?' +
        ...
        wx.ready(function(){
          wx.onMenuShareAppMessage({
            ...
            link: 'http://qb4dwjh.hk1.mofasuidao.cn/exhibit_html/?id=' + this.param.id, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
          ...
          wx.onMenuShareQQ({
            ...
            desc: '在线艺术品超市，展厅,高大上的艺术家都在这里，加关注，不迷路', // 分享描述
            link: 'http://qb4dwjh.hk1.mofasuidao.cn/exhibit_html/?id=' + this.param.id, // 分享链接
            imgUrl: 'http://picturebank.oss-cn-qingdao.aliyuncs.com/onlineExhibition/backround.jpg', // 分享图标
            success: function () {
            },
            cancel: function () {
