  ...
  export default {
    ...
    created() {
      if(this.param.id != undefined ){
        this.$http.get('http://'+ host +'/exhibition/?id='+ this.param.id).then(response => {
      ...
      $(window).scroll(function () {
        ...
        if(_this.is_more_rating === true){
          if(scrpllTop + windowHeight === scroolHeight){
            ...
            _this.$http.get('http://'+ host +'/exhibition_ratings/?id='+ _this.param.id+'&get_count=' + _this.get_count
